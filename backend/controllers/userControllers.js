...
const registerUser = async (req, res) => {
    try {
        ...
        // Preparing user data for saving
        const userData = {
            name,
            email,
        ...
        // Responding with the success message and token
...
const bookAppointment = async (req,res) => {
    ...
    try{
        ...
        // Ckhecking for slot availability
...
console.log("Currency:", process.env.CURRENCY);
  ...
  // API to make payment od appointment using razorpay
